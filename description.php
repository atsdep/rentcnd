					...
					<div class="panel-title-amenities">
						<div class="block-panel">
							...
							<fieldset class="lys-input__fieldset">
								<textarea id="des" name="des" class="lys-summary__textarea hide-scroll"  style="height: 200px;"></textarea>
						...
						<div class="button-panel mgt60">
							...
							<a id="btn-next" name="btn-next" class="btn btn-large btn-primary pull-right" href="#">
