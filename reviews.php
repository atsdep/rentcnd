					...
					<div class="col-md-3 space-sm-4">
						<div class="sidenav">
							<ul class="sidenav-list">
								<li>
									<a href="profile.php" aria-selected="false" class="sidenav-item">แก้ไขข้อมูลส่วนตัว</a>
								</li>
								<li>
						...
						<a href="/users/show/98642671" class="btn btn-block space-top-4">ดูโปรไฟล์</a>
					</div>
					<div class="col-md-9">
								...
								<div class="tab-panel" role="tabpanel" aria-hidden="false" id="received">
									<div class="panel">
										...
										<div class="panel-body">
											<p class="text-lead">
												การแสดงความคิดเห็นบน Airbnb จะทำได้หลังจากเช็คเอาท์แล้ว ความคิดเห็นที่คุณได้รับจะปรากฏที่นี่และบนโปรไฟล์สาธารณะของคุณ
											</p>
