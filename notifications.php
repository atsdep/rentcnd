			...
			<div class="subnav hide-print">
				<div class="page-container-responsive">
					<ul class="subnav-list">
						...
						<li>
							<a href="/rooms" aria-selected="false" class="subnav-item cohosting-ml-tooltip-trigger" id="rooms-item">ที่พักของคุณ</a>
						</li>
						<li>
						...
						<li>
							<a href="/account" aria-selected="true" class="subnav-item" id="account-item">บัญชี</a>
						</li>
						<li>
							<a href="/invite?r=32" class="subnav-item" id="invite-friends-item">เชิญเพื่อน</a>
						</li>
					</ul>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-md-3">
						...
						<ul class="sidenav-list">
							<li>
								<a href="security.php" aria-selected="false" class="sidenav-item">ความปลอดภัย</a>
							</li>
							<li>
					...
					<div class="col-md-9">
						...
						<div class="panel space-top-4">
							...
							<section class="panel-body">
								<div class="row">
									<div class="col-sm-4">
										<p>
											รับข้อมูลการปรับปรุงทางโทรศัพท์มือถือด้วยข้อความ SMS ธรรมดา
										</p>
									</div>
									<div class="col-sm-8">
										<div>
											คุณสามารถเพิ่มและยืนยันเบอร์โทรบนบัญชีของคุณจากหัวข้อ <a href="https://th.airbnb.com/users/edit">แก้ไขโปรไฟล์</a> เมื่อคุณยืนยันเบอร์โทรหนึ่งเบอร์หรือมากกว่านั้นแล้ว การตั้งค่าจะปรากฏที่นี่
										</div>
									</div>
								</div>
							</section>
							...
							<section class="panel-body">
								<div class="row">
									<div class="col-sm-4">
										<h5>ฉันต้องการรับ</h5>
										<p>
											คุณสามารถหยุดใช้งานสิ่งเหล่านี้ได้ตลอดเวลา
										</p>
									</div>
									<div class="col-sm-8">
										...
										<label class="col-sm-11" for="user_profile_info_receive_promotional_email"> โปรโมชันทั่วไป การปรับปรุง ข่าวเกี่ยวกับ Airbnb หรือโปรโมชันทั่วไปสำหรับแคมเปญและบริการหุ้นส่วน แบบสำรวจผู้ใช้ แรงบันดาลใจและความรักจาก Airbnb </label>
										<label class="col-sm-1 checkbox">
											<input name="user_profile_info[receive_informative_email]" type="hidden" value="0">
											<input checked="checked" id="user_profile_info_receive_informative_email" name="user_profile_info[receive_informative_email]" type="checkbox" value="1">
										</label>
										<label class="col-sm-11" for="user_profile_info_receive_informative_email"> การเตือนเกี่ยวกับการจองที่พักและความคิดเห็น </label>
									</div>
								</div>
							</section>
						</div>
							...
							<section class="panel-body">
								<div class="row">
									...
									<div class="col-sm-8">
										...
										<label class="col-sm-11" for="user_can_receive_phone_call"> <strong>การโทรเกี่ยวกับบัญชี ที่พัก การจอง หรือชุมชน Airbnb </strong>
											<br>
											หากคุณเลือกไม่รับ เราจะยังคงโทรหาคุณเกี่ยวกับบัญชีของคุณ หากเป็นเรื่องเร่งด่วนหรือหากอีเมลก่อนหน้านี้ไม่ถึงคุณ </label>
									</div>
								</div>
							</section>
						</div>
						...
						<div class="panel-footer">
							<input class="btn btn-primary" id="user_submit" name="commit" type="submit" value="บันทึก">
						</div>
